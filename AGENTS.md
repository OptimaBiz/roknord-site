...
- Work in local tree.
- Do not push without explicit command.
- Keep scope narrow unless the task says radical visual redesign.
- Use Astro/CSS.
...
- `roknord_art_director`: strict senior visual direction review.
- `roknord_qa_guardian`: strict QA and brand-compliance review.
- `roknord_frontend_implementer`: Astro/CSS implementer for approved Roknord visual briefs.

...
В каждое письмо добавляются версия согласия, серверное и клиентское время, страница отправки, IP-адрес,
User-Agent и уникальный идентификатор обращения. Эти письма нужно сохранять в течение срока, указанного в Политике,
чтобы подтверждать факт и условия получения согласия.
